              ...
              >
                ...
                {isAdmin && (
                  <div className="flex gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                    <button onClick={(e) => { e.stopPropagation(); onEditProgram(prog); }} className="p-1 rounded-lg hover:bg-orange-100 text-gray-600 hover:text-[#f6a623]" title="Редактировать"><Pencil size={14} /></button>
                    <button onClick={(e) => { e.stopPropagation(); onDeleteProgram(prog); }} className="p-1 rounded-lg hover:bg-orange-100 text-gray-600 hover:text-[#f6a623]" title="Удалить"><Trash size={14} /></button>
                    <button onClick={(e) => { e.stopPropagation(); onAddToDepartment(prog); }} className="p-1 rounded-lg hover:bg-orange-100 text-gray-600 hover:text-[#f6a623]" title="В отделение"><FolderPlus size={14} /></button>
                  </div>
                )}
                {hasSubjects && (
                  <ChevronRight
